...
class Bookingform extends React.Component {
  constructor(props) {
    super(props);
    this.state = { chosenDate: new Date(), selected2: "", rstls :[],qty: 1, desc: "", issending : false}
  ...
  async displayvalues(){
    ...
    // alert(xdate)
    const bookling = {lab:mlab ,date: xdate, qty: mqty, desc: mdesc, userid:1} //supply userid here
